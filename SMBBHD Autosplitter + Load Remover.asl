...
state("SMBBBHD")
{
    ...
    // This was found by Ellie (Elisiah)
    ...
    // This was found by KunoDemetries
}
...
update
{
    ...
    if ((current.splitter != old.splitter) && (current.splitter != 0) && (old.splitter == 0) && (current.splitter != null) && (current.splitter != vars.comparison))
    {
        vars.trigger = true;
    }
}
